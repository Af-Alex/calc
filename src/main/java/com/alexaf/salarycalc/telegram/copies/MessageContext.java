...
public class MessageContext {
    ...
    private final SalaryBot bot;

    private MessageContext(Update update, User user, Long chatId, SalaryBot bot, String[] arguments) {
        this.user = user;
        this.chatId = chatId;
        this.update = update;
        this.bot = bot;
    ...
    public static MessageContext newContext(Update update, User user, Long chatId, SalaryBot bot, String... arguments) {
