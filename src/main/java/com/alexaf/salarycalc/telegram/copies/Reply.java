 ...
 * <p>
 * If an update satisfies the {@link Reply#conditions} set by the reply, then it's safe to {@link Reply#actOn(SalaryBot, Update)}.
 *
 * @author Abbas Abou Daya
 */
public class Reply {
    public final List<Predicate<Update>> conditions;
    public final BiConsumer<SalaryBot, Update> action;
    private boolean statsEnabled;
    private String name;

    Reply(List<Predicate<Update>> conditions, BiConsumer<SalaryBot, Update> action) {
    ...
    Reply(List<Predicate<Update>> conditions, BiConsumer<SalaryBot, Update> action, String name) {
    ...
    public static Reply of(BiConsumer<SalaryBot, Update> action, List<Predicate<Update>> conditions) {
        return new Reply(conditions, action);
    }

    @SafeVarargs
    public static Reply of(BiConsumer<SalaryBot, Update> action, Predicate<Update>... conditions) {
    ...
    public void actOn(SalaryBot bot, Update update) {
    ...
    public BiConsumer<SalaryBot, Update> action() {
        return action;
    }
